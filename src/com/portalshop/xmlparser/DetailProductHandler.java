...
public class DetailProductHandler extends DefaultHandler{
	private boolean inData=false,inUrl=false,inBarang=false;
	private StringBuffer buff=null;
	private ParsedDetailProductDataSet myParsedExampleDataSet = new ParsedDetailProductDataSet();
	 
    // ===========================================================
    // Getter & Setter
    // ===========================================================

    public ParsedDetailProductDataSet getParsedData() {
    ...
    public void startDocument() throws SAXException {
            this.myParsedExampleDataSet = new ParsedDetailProductDataSet();
    }
    ...
    public void endElement(String namespaceURI, String localName, String qName)
    	...
    	if (localName.equals("data")) {
            ...
            myParsedExampleDataSet.adduUrl();
    	}else if (localName.equals("url")) {
            this.inUrl = false;
    	}
    }
